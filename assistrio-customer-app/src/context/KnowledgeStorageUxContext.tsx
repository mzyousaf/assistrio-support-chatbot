...
import { useBotWorkspace } from '@/pages/bot-workspace/BotWorkspaceContext';
...
export type KnowledgeStorageUxContextValue = {
  knowledgeUsage: CustomerKnowledgeUsage | undefined;
...
export function KnowledgeStorageUxProvider({ children }: { children: ReactNode }) {
  ...
  const knowledgeUsage = bot?.knowledgeUsage;
