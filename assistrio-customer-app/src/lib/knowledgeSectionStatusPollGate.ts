...
const SECTION_TO_DATA_SOURCE_KEY: Record<KbTrainingAffectedType, CustomerAgentTrainingStatusResponse['dataSources'][number]['key']> =
  {
    document: 'documents',
    faq: 'qna',
    note: 'snippets',
...
export function shouldPollKnowledgeSectionFromAgentTrainingStatus(
  ts: CustomerAgentTrainingStatusResponse | null | undefined,
