...
export function ConversationFilters({ open, onClose, initialDraft, onApply, onClear }: Props) {
  ...
  const topicOptions = useMemo((): SearchableMultiSelectOption[] => {
    return CUSTOMER_TOPICS_ANALYTICS_MAIN_TOPIC_IDS.map((topicId) => ({
      value: topicId,
                  ...
                  onChange={(next) =>
                    setDraft((d) => ({
                      ...
                      startedFromKeys: sortConversationWidgetChannelKeys(
                        next as CustomerChatsAnalyticsStartedFromKey[],
                      ),
                    }))
                  }
                />
                  ...
                  onChange={(next) =>
                    setDraft((d) => ({
                      ...
                      primaryTopicKeys: sortConversationTaxonomyTopicKeys(
                        next as CustomerTopicsAnalyticsTopicId[],
                      ),
                    }))
                  }
                />
              ...
              <FilterInlineRow label="Sentiment" htmlFor="conv-sentiment-ms">
                <SearchableMultiSelect
                  ...
                  onChange={(next) =>
                    setDraft((d) => ({
                      ...d,
                      sentimentKeys: sortConversationSentimentKeys(next as CustomerSentimentLabelId[]),
                    }))
                  }
                />
              </FilterInlineRow>
