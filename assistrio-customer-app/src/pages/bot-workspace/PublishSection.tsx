...
export function PublishSection() {
  ...
  const embedTypeOptions: { value: EmbedInstallMode; label: string; hint: string; disabled?: boolean }[] = [
    { value: 'chat-widget', label: 'Chat widget', hint: 'Script embed with launcher (recommended).' },
    {
      value: 'iframe',
      label: 'Iframe',
      hint: 'Coming soon. Use the chat widget for the full experience.',
      disabled: true,
    },
  ];
    ...
    <div className="flex min-h-0 w-full min-w-0 flex-1 flex-col" data-go-live-editor>
                ...
                <div className="relative min-h-[28rem]">
                  ...
                  >
                    <WorkspaceSectionHeader
                      ...
                      title="Widget Setup"
                      description="Choose how to install the widget and who can use it, then copy the code and keys."
                      inlineEnd={
                        <button
                          type="button"
                    ...
                    <div className="grid min-w-0 grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
                      <div className="flex min-w-0 flex-col gap-6">
                        <ChoiceCardGroup
                          name="Install method"
                          subtitle="Script install with launcher (recommended). Iframe install is shown for reference and will be available later."
                          ...
                          <div className="mb-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                            <div>
                              ...
                              <p className={cn(ws.workspaceEditorHelperText, 'm-0 mt-1')}>
                                Paste this code on your site (e.g., www.chatbase.co) to install the chat widget.
                              </p>
                            </div>
                            <Button
                              type="button"
      ...
      >
        <ol className="m-0 list-decimal space-y-2 pl-5 text-sm leading-relaxed text-slate-700">
          <li>Add at least one allowed website in the list above.</li>
          <li>Select your install method and visibility.</li>
          <li>Click <span className="font-semibold">Copy Snippet</span> to copy the install code.</li>
          <li>Paste that code in the location recommended for your platform (for many sites this is before <span className="font-mono">&lt;/body&gt;</span>).</li>
          <li>Publish your website changes and refresh to confirm the widget appears.</li>
        </ol>
        <p className={cn(ws.workspaceEditorHelperText, 'mt-3 mb-0')}>
          If you want platform-specific instructions, check the platform selector and guidance in the blue box below.
        </p>
      </Modal>
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <Button type="button" variant="primary" size="lg" onClick={() => void saveOriginModal()}>
              Save
            </Button>
          </>
        }
