...
export function LeadsTableRow({ botId, lead, columnDefs, onOpenDetail, onOpenChat }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <LeadIdentityCell lead={lead} />
      </td>
      <td className="min-w-0 px-2 py-2.5 align-middle sm:px-3">
        <LeadStatusCell lead={lead} fieldDefinitions={columnDefs} />
      </td>
