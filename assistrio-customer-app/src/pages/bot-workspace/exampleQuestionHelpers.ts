import type { CustomerBotDetail, CustomerKnowledgeStatusItem } from '@/api/types';
...
import { kbDetailLifecycleRawForDisplay, kbPollRunAfterIso } from './knowledge/knowledgeViewTypes';
import {
  clampStrUtf8Bytes,
