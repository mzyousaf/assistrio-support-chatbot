...
type Props = {
  value: SentimentMetricMode;
  onChange: (v: SentimentMetricMode) => void;
  disabled?: boolean;
};

const tabs: { id: SentimentMetricMode; label: string }[] = [
  { id: 'messages', label: 'By messages' },
  { id: 'conversations', label: 'By conversations' },
];

export function SentimentMetricModeTabs({ value, onChange, disabled }: Props) {
  return (
