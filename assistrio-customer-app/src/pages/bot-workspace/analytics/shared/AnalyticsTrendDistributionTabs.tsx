...
export type AnalyticsTrendDistributionTab = 'trends' | 'distribution';

type Props = {
  value: AnalyticsTrendDistributionTab;
  onChange: (v: AnalyticsTrendDistributionTab) => void;
  disabled?: boolean;
};

const tabs: { id: AnalyticsTrendDistributionTab; label: string }[] = [
  { id: 'trends', label: 'Trends' },
  { id: 'distribution', label: 'Distribution' },
];

/** Matches {@link TopicsChartStyleTabs} — teal selected pill on white chrome (topics analytics). */
export function AnalyticsTrendDistributionTabs({ value, onChange, disabled }: Props) {
  return (
