...
import type { AnalyticsContextPayload, ConversationOriginPayload } from './chat-engine.types';
import { parseConversationOriginFromUnknown } from './conversation-analytics-origin.util';
import { parseAnalyticsContextFromUnknown } from './conversation-analytics-location-device.util';
...
export type ParsedEmbedChatPayload = {
  ...
  embedOrigin?: string;
  /** Knowledge base item id for trainable suggestion-scoped first reply. */
  suggestionId?: string;
