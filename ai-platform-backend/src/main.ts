...
async function bootstrap() {
  ...
  /** Lemon webhooks: capture raw bytes in preParsing, return cloned stream for default JSON parser. */

  registerLemonWebhookRawBodyPreParsingHook(fastify as unknown as FastifyPreParsingHookHost);
