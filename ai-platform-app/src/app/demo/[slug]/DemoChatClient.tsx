...
export default function DemoChatClient({ botSlug, botName }: DemoChatClientProps) {
      ...
      if (response.status === 403 && data?.error === "limit_reached") {
        setMessages((prev) => [
          ...prev,
          {
            ...
            content:
              data.message ??
              "You reached the usage limit for this showcase bot.",
          },
        ]);
        return;
      }
  ...
  return (
    <main className="flex min-h-screen flex-col bg-zinc-950 text-zinc-100">
      <header className="border-b border-zinc-800 px-6 py-4">
        ...
        <p className="text-sm text-zinc-400">Showcase bot</p>
      </header>
