...
const reasons = [
  ...
  },
  {
    ...
    body: "Evaluate on real allowed websites, then graduate the same bot to Launch when you are ready — no throwaway demo stack.",
  },
];
      ...
      <Container>
        <ScrollReveal y={20}>
          <HomeSectionHeader id="why-hosted-heading" eyebrow="Commercial" title="Why businesses choose Launch" titleWide align="split">
            <p>
              <strong className="font-semibold text-slate-800">Launch</strong> is where we answer commercial questions: who runs uptime, patches, and incident response, how you
