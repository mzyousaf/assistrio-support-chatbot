...
/**
 * Legacy 4-step “Explore” trial modal (intro → hostname → workspace id → TrialForm).
 * Kept for safe rollback — not rendered by default. See `trial-flow-modal.tsx`.
 */
...
export function TrialExploreFlowModalLegacy({ open, onClose }: Props) {
