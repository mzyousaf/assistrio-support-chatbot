...
export function isKnowledgeStorageDatasheetViewOnly(usage: AdminKnowledgeUsage | null | undefined): boolean {
...
export function isKnowledgeStorageFull(knowledgeUsage: AdminKnowledgeUsage | null | undefined): boolean {
...
export function isKnowledgeStorageLow(knowledgeUsage: AdminKnowledgeUsage | null | undefined): boolean {
  if (!knowledgeUsage) return false;
...
/** Client-side outcome before an action that adds UTF-8 bytes toward {@link AdminKnowledgeUsage.totalBytes}. */
...
export function knowledgeStorageIncreaseOutcome(
  usage: AdminKnowledgeUsage | null | undefined,
