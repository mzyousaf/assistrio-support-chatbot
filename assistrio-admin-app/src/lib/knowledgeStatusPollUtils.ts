 ...
 */
export function knowledgeStatusPollRowPipelineRank(it: AdminKnowledgeStatusItem): number {
...
export function pickBetterKnowledgeStatusItem(
  a: AdminKnowledgeStatusItem,
  b: AdminKnowledgeStatusItem,
...
export function resolveFaqPollRow(
  slice: AdminKnowledgeStatusItem[],
  listIndex: number,
  knowledgeItemId?: string | null,
): AdminKnowledgeStatusItem | null {
...
export function knowledgeStatusItemSection(it: AdminKnowledgeStatusItem): KbTrainingAffectedType | null {
  const st = typeof it.sourceType === 'string' ? it.sourceType.trim().toLowerCase() : '';
...
export function mergeKnowledgeStatusItemsReplacingSection(
  prev: AdminKnowledgeStatusItem[] | null | undefined,
  section: KbTrainingAffectedType,
  incoming: AdminKnowledgeStatusItem[],
): AdminKnowledgeStatusItem[] {
  const base = prev ?? [];
...
export function mergeKnowledgeStatusItemsReplacingManySections(
  prev: AdminKnowledgeStatusItem[] | null | undefined,
  updates: Array<{ section: KbTrainingAffectedType; items: AdminKnowledgeStatusItem[] }>,
): AdminKnowledgeStatusItem[] {
  let acc = [...(prev ?? [])];
