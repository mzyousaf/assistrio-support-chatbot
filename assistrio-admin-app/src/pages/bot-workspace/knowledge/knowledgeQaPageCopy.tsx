...
export const QA_EDIT_TITLE_INFO =
  'Changes save to this bot’s knowledge base. Training may run again after you save.';
...
export const QA_LIST_AND_DETAIL_TITLE_INFO =
  'Preset answers for important topics. Your bot checks Q&A before the rest of your knowledge.';
