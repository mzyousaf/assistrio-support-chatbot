...
const PAGE_TITLE = 'Bot behavior';

/** Matches `AgentWorkspaceSidebar` Playground label (`playground/behavior`). */
const BEHAVIOR_SECTION_NAV_LABEL = 'Behavior';
          ...
          <header className={ws.workspaceEditorPageHeader}>
            <div className={ws.workspaceEditorTitleBlock}>
              <div className={ws.workspaceEditorHeadingStack}>
                ...
                <p className={ws.workspaceEditorLead}>
                  Shape tone, categories, and opening messages—so every reply matches how you want your bot to
            ...
            <div className="flex shrink-0 flex-col sm:pt-0">
              <Button
                ...
                aria-label={saving ? `Saving ${BEHAVIOR_SECTION_NAV_LABEL}` : `Save ${BEHAVIOR_SECTION_NAV_LABEL}`}
              >
                {saving ? (
                  <>
                  ...
                  <>
                    ...
                    Save {BEHAVIOR_SECTION_NAV_LABEL}
                  </>
                )}
              </Button>
            </div>
                      ...
                      <div className={ws.workspaceEditorFieldStack}>
                        ...
                        >
                          <Textarea
                            ...
                            placeholder="Extend or customize how the bot should behave—priorities, style, and boundaries."
                            className={cn(
