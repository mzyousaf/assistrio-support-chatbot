import type { AdminTopicsAnalyticsTopicId } from '@/api/types';
import { ADMIN_TOPICS_ANALYTICS_MAIN_TOPIC_IDS } from '@/api/types';

/** Stable taxonomy order (matches API / backend `TOPIC_TAXONOMY_IDS`). */
export const TOPIC_TAXONOMY_ORDER: readonly AdminTopicsAnalyticsTopicId[] =
  ADMIN_TOPICS_ANALYTICS_MAIN_TOPIC_IDS;
...
export const TOPIC_DISPLAY_FALLBACK = {
  ...
  other: 'Other',
} as const satisfies Record<AdminTopicsAnalyticsTopicId, string>;
