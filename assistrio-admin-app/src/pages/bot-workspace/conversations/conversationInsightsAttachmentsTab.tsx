...
import type { AdminConversationMessage, AdminConversationMessageAttachment } from '@/api/types';
...
function flattenedConversationAttachments(messages: AdminConversationMessage[]) {
  const out: Array<{
    key: string;
    raw: AdminConversationMessageAttachment;
    createdAt: string;
  }> = [];
