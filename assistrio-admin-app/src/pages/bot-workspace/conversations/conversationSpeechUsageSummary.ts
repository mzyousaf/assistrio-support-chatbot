...
function addVoiceMetaTotals(m: AdminConversationMessage, acc: ConversationSpeechUsageSummary): void {
  const v = m.voiceMeta;
  if (!v) return;
...
function addSpeechInputDuration(m: AdminConversationMessage, acc: ConversationSpeechUsageSummary): void {
...
export function buildConversationSpeechUsageSummary(
  messages: AdminConversationMessage[] | null | undefined,
