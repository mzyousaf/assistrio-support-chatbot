...
export function ConversationInsightsGeneralTab({
  ...
  listItem: AdminConversationListItem;
...
export function ConversationInsightsVisitorTab({ detail }: { detail: AdminConversationDetail }) {
...
export function ConversationInsightsLeadTab({ detail }: { detail: AdminConversationDetail }) {
