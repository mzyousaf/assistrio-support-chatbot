...
import type { AdminConversationSentimentSummary, AdminConversationTopicsSummary } from '@/api/types';
...
type Props = {
  topics?: AdminConversationTopicsSummary;
  sentiment?: AdminConversationSentimentSummary;
  className?: string;
};

function rollupMainAndSubs(topics: AdminConversationTopicsSummary | undefined): {
  mainId: string;
  subIds: string[];
} {
