    ...
    <div className={cx(theme === "dark" && "dark", "admin-theme min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 flex font-body")}>
      <aside className="hidden md:flex flex-col w-64 border-r border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur shadow-card">
        <div className="h-16 flex items-center px-5 border-b border-gray-200 dark:border-gray-800">
          <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-brand-500 to-brand-700 flex items-center justify-center text-white font-bold text-sm shadow-card ring-1 ring-brand-400/30">
            AI
          </div>
          <div className="ml-3">
            <div className="text-sm font-heading font-semibold text-gray-900 dark:text-gray-100">Assistrio</div>
            <div className="text-xs text-gray-500 dark:text-gray-400">Support Console</div>
          </div>
        </div>
