...
import type { WidgetPreviewOverrides } from "@/embed/types";
...
export function AdminLiveChatAdapter({
  ...
  const subtitle =
    ...
    (mode === "preview" ? "Preview" : "Live test");
  ...
  const privacyTextResolved =
    showBranding
      ? (footerPrivacyText ??
        (mode === "preview"
          ? "Preview — your conversations use draft settings when you send messages."
          : "Your test conversations are not stored."))
      : undefined;
