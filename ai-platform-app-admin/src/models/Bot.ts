...
export interface BotChatUI {
  ...
  /** When true, suggestion chips hide visible label text in the widget (still tappable). */
...
export interface BotDocument {
  name: string;
  slug: string;
  /** When true, bot was created from the curated agents pack (caps / bulk actions may apply). */
  ...
  config?: BotConfig;
  /** Runtime allowlist: exact page origins only (`https://host[:port]`). */
