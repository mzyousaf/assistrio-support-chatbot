          ...
          <table className="min-w-full text-left text-sm">
            <thead className="bg-gray-50 text-gray-600 dark:bg-gray-800 dark:text-gray-300">
              <tr>
                ...
                <th className="px-4 py-3 text-right font-medium uppercase tracking-wide text-xs">Legacy tag 1</th>
                <th className="px-4 py-3 text-right font-medium uppercase tracking-wide text-xs">Legacy tag 2</th>
              ...
              {bots.map((row) => {
                ...
                return (
                  <tr key={row.botId} className="transition-colors hover:bg-gray-50/80 dark:hover:bg-gray-800/40">
                    ...
                    <td className="px-4 py-3 text-right tabular-nums">{row.legacyTaggedUserMessagesBucket1}</td>
                    <td className="px-4 py-3 text-right tabular-nums">{row.legacyTaggedUserMessagesBucket2}</td>
