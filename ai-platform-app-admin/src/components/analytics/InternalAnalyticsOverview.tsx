        ...
        <div className="space-y-10">
          {overview ? (
            <>
              ...
              <Section
                title="Site analytics (visitor events)"
                description="Anonymous marketing visitorId events in the selected window (legacy event type names may still appear in stored rows)."
              >
                ...
                <AnalyticsStatCard
                  label="Events: trial_bot_created"
                  value={overview.overview.legacyVisitorEventCounts.trial_bot_created}
                />
                <AnalyticsStatCard
                  label="Events: trial_create_started"
                  value={overview.overview.legacyVisitorEventCounts.trial_create_started}
                />
                <AnalyticsStatCard
                  label="Events: trial_create_succeeded"
                  value={overview.overview.legacyVisitorEventCounts.trial_create_succeeded}
                />
              </Section>

              <Section title="Chat volume (range)" description="Messages and conversations in the selected window.">
                <AnalyticsStatCard
                  label="User messages (legacy tag bucket 1)"
                  value={overview.messages.legacyTaggedUserMessagesBucket1}
                  hint="Message.showcaseRuntimeUserMessage === true"
                />
                <AnalyticsStatCard
                  label="User messages (legacy tag bucket 2)"
                  value={overview.messages.legacyTaggedUserMessagesBucket2}
                  hint="Message.trialRuntimeUserMessage === true"
                />
              ...
              <Section title="Inventory & leads" description="Bots and lead capture (see caveats for scope).">
                <AnalyticsStatCard label="Bots created in range" value={overview.bots.botsCreatedInRange} />
                <AnalyticsStatCard
                  label="Published bots (now)"
                  value={overview.bots.publishedBotsCount}
                  hint="Point-in-time count of published bots (not range-scoped)."
                />
                <AnalyticsStatCard
