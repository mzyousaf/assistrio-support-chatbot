...
import type { AllowedOriginFormRow } from "@/lib/embedAllowedOrigins";
...
export interface BotFormEditorModel {
  ...
  emptyAllowedOriginRow: () => AllowedOriginFormRow;

  allowedOriginRows: AllowedOriginFormRow[];
  setAllowedOriginRows: Dispatch<SetStateAction<AllowedOriginFormRow[]>>;
  ...
  hasImage: boolean;
  previewSrc: string;
  hasAllowedRuntimeOrigin: boolean;
  allowedOriginsPreviewLines: string[];
